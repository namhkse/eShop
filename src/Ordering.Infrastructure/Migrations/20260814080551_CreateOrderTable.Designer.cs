...
namespace Ordering.Infrastructure.Migrations
{
    ...
    [Migration("20260814080551_CreateOrderTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ordering.Domain.BuyerAggregate.CardType", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Ordering.Domain.BuyerAggregate.PaymentMethod", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Ordering.Domain.BuyerAggregate.PaymentMethod", b =>
                {
                    b.HasOne("Ordering.Domain.BuyerAggregate.Buyer", null)
                        .WithMany("PaymentMethods")
                        .HasForeignKey("BuyerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Ordering.Domain.BuyerAggregate.CardType", "CardType")
                        .WithMany()
            ...
            modelBuilder.Entity("Ordering.Domain.OrderAggregate.Order", b =>
                {
                    b.HasOne("Ordering.Domain.BuyerAggregate.Buyer", "Buyer")
                        .WithMany()
                        .HasForeignKey("BuyerId");

                    b.HasOne("Ordering.Domain.BuyerAggregate.PaymentMethod", null)
                        .WithMany()
